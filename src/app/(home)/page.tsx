              ...
              <div className="relative group">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 sm:px-6 lg:px-8 py-4 sm:py-6 pr-4 sm:pr-48 rounded-3xl bg-white border-2 border-gray-200 focus:border-purple-500 outline-none text-lg transition-all shadow-xl hover:shadow-2xl placeholder:text-gray-400"
